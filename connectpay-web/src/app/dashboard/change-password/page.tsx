  ...
  return (
    <div className="page-container">
      ...
      {showSuccessModal && (
        <div className="modal-overlay" onClick={handleCloseSuccessModal}>
          <div className="modal-content success-modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <h2 className="success-modal-title">Password Updated!</h2>
            <p className="success-modal-subtitle">Your password has been changed successfully</p>
      ...
      <style jsx>{`
        ...
        .text-input { width: 100%; padding: 12px 44px 12px 14px; font-size: 15px; border: 1px solid #d1d5db; border-radius: 6px; transition: all 0.2s; color: #1f2937; font-weight: 500; }
        ...
        .password-toggle { position: absolute; right: 12px; background: none; border: none; color: #6b7280; cursor: pointer; padding: 4px; display: flex; align-items: center; justify-content: center; transition: color 0.2s; }
        .password-toggle:hover:not(:disabled) { color: #dc2626; }
        .password-toggle:disabled { opacity: 0.5; cursor: not-allowed; }
        .message { padding: 12px; border-radius: 6px; font-size: 14px; font-weight: 500; margin-bottom: 16px; text-align: center; }
        .message.error { background: #fef2f2; color: #dc2626; border: 1px solid #fecaca; }
        .message.success { background: #f0fdf4; color: #16a34a; border: 1px solid #bbf7d0; }
        .submit-btn { width: 100%; padding: 14px; background: #dc2626; color: white; font-size: 16px; font-weight: 600; border: none; border-radius: 6px; cursor: pointer; transition: all 0.2s; margin-bottom: 24px; }
        ...
        .modal-content { background: white; border-radius: 16px; padding: 32px 24px; max-width: 400px; width: 100%; position: relative; box-shadow: 0 20px 25px -5px rgba(0,0,0,0.1); animation: slideUp 0.3s ease-out; }
        ...
        .success-icon { margin: 0 auto 24px; display: flex; justify-content: center; }
        .success-modal-title { font-size: 22px; font-weight: 700; color: #1f2937; margin: 0 0 8px 0; }
        .success-modal-subtitle { font-size: 14px; color: #6b7280; margin: 0 0 24px 0; }
