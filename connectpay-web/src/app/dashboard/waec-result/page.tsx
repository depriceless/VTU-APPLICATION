...
export default function BuyWaec() {
  ...
  const fetchEducationPackages = async () => {
    ...
    try {
        ...
        if (packagesData.waec && Array.isArray(packagesData.waec)) {
          packagesData.waec.forEach((pkg: any) => {
            transformedCards.push({
              ...
              examBody: 'WAEC', // ✅ FIXED: Use uppercase to match backend requirements
      ...
      alert('Failed to load WAEC packages. Please refresh the page.');
    } finally {
  ...
  return (
    <div className="page-container">
      <div className="page-header">
        <h1 className="page-title">BUY WAEC PINS</h1>
        <div className="breadcrumb">
          <span className="breadcrumb-link">Dashboard</span>
          <span className="breadcrumb-separator">/</span>
          <span className="breadcrumb-current">WAEC</span>
        </div>
      </div>
      ...
      {currentStep === 1 ? (
        <div className="card">
          ...
          <div className="form-section">
            <label className="section-label">Select WAEC Exam Card</label>
            {isLoadingPackages ? (
              <div className="loading-plans">
                <div className="spinner-small"></div>
                <span>Loading WAEC packages...</span>
              </div>
            ) : examCards.length === 0 ? (
              <div className="empty-state">No WAEC packages available</div>
            ) : (
