...
export default function ResetPasswordPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (status === 400) {
        setErrorMessage(message || 'Invalid or expired reset link. Please request a new one.');
      } else if (status === 429) {
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-6 sm:p-8">
            ...
            {success ? (
              ...
              <div className="text-center py-2">
                ...
                <Link
                  href="/login"
                  className="w-full inline-flex justify-center items-center py-3 px-4 border border-transparent text-base font-bold rounded-xl text-white bg-red-600 hover:bg-red-700 transition-colors"
                >
                  Go to Sign In
                </Link>
              </div>
              ...
              <>
                <div className="text-center mb-8">
                  ...
                  <p className="text-sm text-gray-500 leading-relaxed">
                    Choose a strong password for your ConnectPay account.
                  </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className={`appearance-none block w-full px-4 py-3 pr-12 border ${
                          confirmPasswordError ? 'border-red-500 bg-red-50' : 'border-gray-300 bg-white'
                        } placeholder-gray-500 text-gray-900 rounded-xl focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent text-base transition-colors`}
                      />
                      <button
                        type="button"
                  ...
                  <button
                    ...
                    className={`w-full flex justify-center items-center py-3 px-4 border border-transparent text-base font-bold rounded-xl text-white transition-colors ${
                      loading || !token ? 'bg-red-300 cursor-not-allowed' : 'bg-red-600 hover:bg-red-700'
