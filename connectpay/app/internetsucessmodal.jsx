...
const InternetSuccessModal: React.FC<SuccessModalProps> = ({ 
  visible, 
  onClose, 
  onBuyMore, 
  transaction, 
    ...
    >
      <View style={styles.overlay}>
        <View style={styles.modalContainer}>
          ...
          {/* Title */}
          <Text style={styles.title}>Internet Subscription Successful!</Text>

          {/* Content */}
          <Text style={styles.subtitle}>{providerName} Internet Plan Activated</Text>
          ...
          <Text style={styles.thankYou}>Your internet plan has been activated successfully!</Text>
          ...
          <View style={styles.buttonContainer}>
            <TouchableOpacity 
              ...
              onPress={onBuyMore}
            >
              <Text style={styles.buyMoreText}>Buy More Internet</Text>
            </TouchableOpacity>
...
export default InternetSuccessModal;